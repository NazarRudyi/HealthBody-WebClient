 ...
 * 
 */
@WebServiceClient(name = "HealthBodyServiceImplService", targetNamespace = "http://webservice.healthbody.softserveinc.edu/", wsdlLocation = "http://0.0.0.0:8080/HealthBody-WebService/HealthBodyService?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://0.0.0.0:8080/HealthBody-WebService/HealthBodyService?wsdl");
